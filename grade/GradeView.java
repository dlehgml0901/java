...
public class GradeView extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == submitButton) {
			...
			englishText.setText("60,70,80,90,100");
			mathText.setText("80,70,50,70,90");
			javaText.setText("50,70,80,40,60");
			...
			String print = gradeService.printGrades();
			String result = "";
			...
			mathText.setText("");
			javaText.setText("");
			resultText.setText(result + print);
		}
